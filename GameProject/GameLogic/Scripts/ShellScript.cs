...
namespace GameProject.GameLogic.Scripts
{
    ...
    {
        public Vector2F Impulse { get; set; }
        ...
        {
            var raycastDir = Impulse.Normalized * MachineEditor.CellSize * 0.55f;
            if (bodyA is null)
            ...
            if (bodyA != null && joint != null)
            {
                ...
                Entity.GetComponent<PhysicsBody>().ApplyLinearImpulse(-Impulse);
            }
            OnExplode?.Invoke();
        }
